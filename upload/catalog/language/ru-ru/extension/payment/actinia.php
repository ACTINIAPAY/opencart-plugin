<?php
// Text
$_['text_title'] = 'Actinia VISA/MasterCard';
...
$_['error_actinia'] = 'Оплата отклонена по причине :';
$_['error_kod'] = 'Код ошибки :';
$_['order_desq'] = 'Оплата заказа №:';
$_['order_confirm_pretext'] = 'После подтверждения заказа, Вы будете направлены на страницу сервиса "Actinia" для оплаты картой.';
?>