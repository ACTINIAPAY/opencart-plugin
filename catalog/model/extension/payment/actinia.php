...
//        die('<pre> ' . print_r($this->resultData, true) . '<pre>');
...
//            echo ('<pre> sendToApi ' . print_r($this->resultData, true) . '<pre>');
            throw new Exception($this->getErrorMsg());
        }
    }
    ...
    protected function JWTencode($data){
        try{
            ...
            $privateKey = file_get_contents(DIR_DOWNLOAD . 'ActiniaPrivate.key');
